...
import com.uit.learnarduino.Tol4.Tol4_ContentButton2;
import com.uit.learnarduino.Tol4.Tol4_ContentButton3;
import com.uit.learnarduino.Tol4.Tol4_ContentButton4;
import com.uit.learnarduino.Tol4.Tol4_ContentButton5;
import com.uit.learnarduino.Tol4.Tol4_MainContent;
    ...
    private void ButtonLesson(CardView button, final int value, final boolean hascolor)
    {
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(value == 3) {
                    Intent i = new Intent(Movement.this, Tol4_ContentButton3.class);
                    i.putExtra("LESSONNUMBERINTENT", value);
                    Log.d(TAG, "test onClick: " + value);
                    i.putExtra("HASCOLOR", hascolor);
                    i.putExtra("MAXLED", max_led);
                ...
                if(value == 4) {
                    Intent i = new Intent(Movement.this, Tol4_ContentButton4.class);
                    i.putExtra("LESSONNUMBERINTENT", value);
                    Log.d(TAG, "test onClick: " + value);
                    i.putExtra("HASCOLOR", hascolor);
                    i.putExtra("MAXLED", max_led);
